    ...
    return (
      <div className="mb-40 my-16 flex flex-col w-11/12 mx-auto">
        ...
        <div className="relative lg:px-8 lg:max-w-screen-xl grid lg:gap-8 gap-4 row-gap-5 mb-8 mx-auto md:row-gap-8 lg:grid-cols-3 sm:grid-cols-2">
          ...
          <div onClick={() => this.setState({ displayReward: 'Champions' })}
            className="cursor-pointer p-5 duration-300 max-w-xs active:bg-black mx-auto transform bg-white border rounded shadow-sm hover:-translate-y-2">
          ...
          <div onClick={() => this.setState({ displayReward: 'Rivals' })}
            className="cursor-pointer p-5 duration-300 max-w-xs mx-auto transform bg-white border rounded shadow-sm hover:-translate-y-2">
            <div className="flex items-center justify-between mb-2">
          ...
          <div onClick={() => this.setState({ displayReward: 'Objectives' })}
            className="cursor-pointer p-5 duration-300 max-w-xs mx-auto transform bg-white border rounded shadow-sm hover:-translate-y-2">
            <div className="flex items-center justify-between mb-2">
